        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    APELLIDO_USUARIO = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
                    NOM_CENTRO_FORMACION = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
                    NOMBRE_PRODUCTO = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
                    TIPO_PRODUCTO = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
                    CANTIDAD = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Factura__3214EC27E2C01B1D", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NOMBRE_PRODUCTO = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: true),
                    CANTIDAD = table.Column<int>(type: "int", nullable: true),
                    FECHA_INGRESO = table.Column<DateTime>(type: "date", nullable: true),
                    IMAGEN_PRODUCTO = table.Column<string>(type: "varchar(255)", unicode: false, maxLength: 255, nullable: true),
                    ...
                    CODIGO_INVIMA = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Producto__3214EC27BAAEF4F5", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SEG_APELLIDO = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
                    ...
                    CODIGO_POSTAL = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
                    ...
                    ESTADO_CIVIL = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
                    NOMBRE_CENTRODE_FORMACION = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Usuario__3214EC277CD01E2D", x => x.ID);
                });
